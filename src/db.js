...
module.exports = {
  ...
  playlist: {
    ...
    set: function(team_id, slack_channel_id, spotify_playlist_id) {
      set(team_id, 'channels.'+slack_channel_id+'.spotify_playlist_id', spotify_playlist_id);
    },
  },
  spotify_username: {
    get: function(team_id, user_id) {
    ...
    set: function(team_id, user_id, spotify_username) {
      setUser(team_id, user_id, 'spotify_username', spotify_username);
    },
  },
};
